...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="selection:text-white">
            @if (Route::has('login'))
                <div class="nav shadow-lg p-6 text-right z-10">
                    @auth
            ...
            <div class="benvenuto ">
                <div class="testo">
                    <h1 class="titolone">La piattaforma per chi vuole cancellare ogni limite alla tua cucina!</h1>
                </div>
            </div>
